<%--
    Document   : printInvestigationDetail
    Created on : Aug 8, 2014, 12:40:04 PM
    Author     : sultan
--%>
...
window.back();
    ...
    <table  width="100%">
                ...
                <tbody>
                    ...
                    <tr><td style="width: 45%" align="left">Invoice No: <c:out value="${investigationbill.investigationbillid}"/></td></tr>
