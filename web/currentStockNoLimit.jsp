<%-- 
    Document   : currentStockNoLimit
    Created on : Feb 11, 2016, 12:11:07 PM
    Author     : kamal
--%>
        ...
        <form name="form1" id="form1" action="" method="post">
            <div class="wrapper"><!--wrapper started-->
                <div class="header_new">
                    <center><strong >Medicine Current Stock </strong></center>
                </div>
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${medicines}" var="crrentstock">
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    ...
                                    <td  class="dataText"><a class="dataTextActiveEmpty" href="Controller?process=MedicineProcess&action=viewMedicineDetails&id=<c:out value="${crrentstock.medicine.id}" />"><c:out value="${crrentstock.medicine.name}"/></a></td>
                                    <td  class="dataText"><c:out value="${crrentstock.medicine.strength}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.medicine.nature}"/></td>

                                    <td  class="dataText"><c:out value="${crrentstock.availablestock}"/></td>
                                    <td class="dataText"><fmt:formatDate pattern="dd-MM-yyyy" value="${crrentstock.expirydate}"  /></td>
