...
background-image: url();background-repeat: no-repeat;background-position: center;
               ...
               for (var i=0; i<document.getElementById('consultantname').options.length; i++)
                {
                    ...
                    {
                        alert('This Operation Type Information  is Already Exist');
                        break;
                    }
                }
        ...
        <script >
            function backButtton1()
            {
                ...
                window.location='OperationTab.jsp';
        ...
        <form id="form1"  action="" method="POST" >
            <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add Bill Type Information</span></div></td>
                </tr>
            </table>
                ...
                <tr>
                    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" onkeyup="exist(this.value);" name="Operationtypename" id="Operationtypename" onkeypress="valueExistsChangeColor()" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="operationtypecharges" id="operationtypecharges" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                                                    ...
                                                    <select    name='consultantname' id="consultantname"  style="width:180px">
                                                        ...
                                                        <%
                                                                    ...
                                                                    Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5433/plexus_version1", "postgres", "plexus");
                                                                     ...
                                                                     ResultSet rs = stmt.executeQuery("Select * from operationtype");
                                                                    while (rs.next()) {
                                                        %>
         ...
         <script type="text/javascript">
          ...
          var country=document.getElementById("Operationtypename");
