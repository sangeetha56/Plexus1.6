<%-- 
    Document   : addConsultancy
    Created on : Jul 28, 2014, 5:34:34 PM
    Author     : sultan
--%>
...
background-image: url();background-repeat: no-repeat;background-position: center;
               ...
               for (var i=0; i<document.getElementById('consultantname').options.length; i++)
                {
                    ...
                    {
                        alert('This Consultancy Type Information  is Already Exist');
                        break;
                    }
                }
        ...
        <script language="Javascript">
            ...
            {
                if( document.getElementById("ConsultancyTypeName").value.length==0 )

                {
                    document.getElementById("ConsultancyTypeName").style.background='red';

                    alert("Enter Consultancy Name");
         ...
         <script language="Javascript">
            ...
            function valueExistsChangeColor()
            {
                ...
                {
                    document.getElementById("ConsultancyTypeName").style.background='white';
    ...
    <body >
        ...
        <form id="form1"  action="" method="POST" >
            ...
            <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add New Consultancy Type</span></div></td>
                </tr>
            </table>
                ...
                <tr>
                    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" onkeyup="exist(this.value);" name="ConsultancyTypeName" id="ConsultancyTypeName" onkeypress="valueExistsChangeColor()" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="ConsultancyTypeCharges" id="ConsultancyTypeCharges" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                                                    ...
                                                    <select    name='consultantname' id="consultantname"  style="width:180px">
                                                        ...
                                                        <%
                                                                    ...
                                                                    Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5433/plexus_version1", "postgres", "plexus");
                                                                     ...
                                                                     ResultSet rs = stmt.executeQuery("Select * from consultancytype");
                                                                    while (rs.next()) {
                                                        %>
         ...
         <script type="text/javascript">
            ...
            function addConsultancyType(){
          var country=document.getElementById("ConsultancyTypeName");

                var form1=document.getElementById("form1");
                 alert(form1.ConsultancyTypeName.value)
                form1.action="Controller?process=ConsultancyProcess&action=add";
              form1.submit();
