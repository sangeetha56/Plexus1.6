                    ...
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${patientList}" var="patient">
                                ...
                                <tr class="trClass"  >
                                    <td class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.advancecharges}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.id}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.advancecharges}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.cardno}"/></td>
                                    <td class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.advancecharges}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out  value="${patient.name}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.advancecharges}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.telephoneno}"/></td>
