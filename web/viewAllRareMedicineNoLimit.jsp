<%-- 
    Document   : viewAllRareMedicineNoLimit
    Created on : Feb 11, 2016, 2:32:30 PM
    Author     : kamal
--%>
        ...
        <form name="form1" id="form1" action="" method="post">
            <div class="wrapper"><!--wrapper started-->
                <div class="header_new">
                    <center><strong >Rarely Used Medicine  List </strong></center>
                </div>
                ...
                <div class="">
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        ...
                        <tr>
                            ...
                            <th title="click to sort" class="headerText">Last Dispensed Date</th>
                    ...
                    <tbody  >
                        <c:forEach varStatus="count"  items="${ratreStocks}" var="stock"  >
                            ...
                            <tr class="gradeA" >
                                ...
                                <td  class="dataText"><fmt:formatDate pattern="dd-MM-yyyy" value="${stock.medicine.lastaccessdate}" /></td>
 ...
 <br/>
           ...
           <script type="text/javascript">
                    ...
                    function CallFunction()
                    {
                        ...
                        form1.action="Controller?process=StockProcess&action=viewAllRareMedicineNoLimit&alphabit=null";
