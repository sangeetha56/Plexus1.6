    ...
    <frameset    rows="80,*,55"frameborder="0" border="0" framespacing="0"  >
        <frame   src="plexus_h.html"   name="topFrame" scrolling="NO" noresize frameborder="0">
            ...
            <frameset  cols="200,*" frameborder="1" border="1" framespacing="0">
                <frame  src="left_medical.jsp" name="leftFrame" scrolling="NO" noresize frameborder="0"   />
                <frame src="Controller?process=InPatientProcess&action=viewAll&patientControllerValue=null&noOfRecords=20&pageno=1&alphabit=null" name="mainFrame" scrolling="yes"  />
            </frameset>
