<%-- 
    Document   : viewBill_kamal
    Created on : Jul 10, 2014, 1:14:17 PM
    Author     : sultan
--%>
...
<html>
    <head>
        ...
        <title>Consultation Charges</title>
        <style type="text/css" >
            <!--
            .header {
    ...
    <body>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#consultationDate2day").val(getCurrentDate());
                $("#consultationDate2day").datepicker();
                $("#show2day").button();
        ...
        <script type="text/javascript">
            $(function() {
                ...
                .button()
                .click(function() {
                    showBetweendateConsultant();

                });
                $( "#thismonth" )
                .button()
                .click(function() {
                    showConsultantThisMonth();
        ...
        <script type="text/javascript">
            function show2dateConsultant(){

                //alert('llll');

                var form1=document.getElementById("form1");
                var dateTodays=document.getElementById("consultationDate2day").value;
                //alert(dateTodays);

                form1.action="Controller?process=BillProcess&action=showTodaysBills";
                form1.submit();

            }

            function showBetweendateConsultant(){

                //alert('2222llll');

                var form1=document.getElementById("form1");

                form1.action="Controller?process=BillProcess&action=showBetweenDateBills";
                form1.submit();

            }

            function showConsultantThisMonth(){

                //alert('showDispenseThisMonth');

                var form1=document.getElementById("form1");

                form1.action="Controller?process=BillProcess&action=showConsultantForThisMonth";
                form1.submit();
        ...
        <form id="form1" action="Controller?process=BillProcess&action=showBillsByDate" method="post">
            <table width="100%">
                <tr>
                    <td  class="headerTD">Consultation View All</td>
                </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="7%"><div align="left">
                                        <label>
                                            <input type="text" name="consultationDate" id="consultationDate" size="10" />
                                        </label>
                                    </div></td>
                ...
                <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td width="7%"><div align="left">
                                    <label>
                                        <input style="display: none" type="text"  name="consultationDate2day" id="consultationDate2day" />
                                    </label>
                                </div></td>
                            <td width="11%"><div align="left"></div></td>
                            <td width="13%"><div align="left"></div></td>
                ...
                <table  width="100%"   id="" border="1">
                    <tr>
                        <td  colspan="2" class="headerTD">Summary of Consultation Billing for&nbsp;&nbsp;&nbsp;  <fmt:formatDate pattern="dd MMMM yyyy " value="${firstdate}" /> To <fmt:formatDate pattern="dd MMMM yyyy " value="${secondtdate}" /> </td>
                    </tr>
                ...
                <table  width="100%"   id="myTable" border="1">
                    ...
                    <tbody >
                        ...
                        <c:forEach items="${bills}" var="bill">
                            <tr style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td class="dataText"  ><c:out value="${bill.visit.patient.name}"/></td>
                                <td class="dataText"  ><c:out value="${bill.visit.consultancytypename}"/></td>
                                <td class="dataText"  ><fmt:formatDate pattern="dd-MM-yyyy " value="${bill.visit.visittime}" /> at <fmt:formatDate pattern="hh:mm a" value="${bill.visit.visittime}" /></td>
                                <td class="dataText"  ><c:out value="${bill.consultationcharges}"/></td>
                    ...
                    <tfoot>
                        ...
                        <tr >
                            ...
                            <td class="headerTDLastRow" colspan="4" align="right">Total</td>
    ...
    <td width="12%"><div>
      <table  width="100%"   id="" border="1">
                    ...
                    <tbody >
                        ...
                        <c:forEach items="${bills}" var="bill">
                            <tr style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                <td class="dataText" ><a href="Controller?process=BillProcess&action=showBillById&id=<c:out value="${bill.id}"/>">Preview</a>&nbsp;<a  href="Controller?process=BillProcess&action=printConsultationCharge&id=<c:out value="${bill.id}"/>">Print!</a></td>
