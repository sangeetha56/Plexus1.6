    ...
    <frameset    rows="80,*,55"frameborder="0" border="0" framespacing="0"  >
        <frame   src="plexus_h.html"   name="topFrame" scrolling="NO" noresize frameborder="0" />
            ...
            <frameset  cols="200,*" frameborder="1" border="1" framespacing="0">
                <frame  src="left_doctor.jsp" name="leftFrame" scrolling="yes"   frameborder="1"   />
                <frame src="Controller?process=VisitProcess&action=viewTodaysAppointment&isPatientSelected=no" name="mainFrame" scrolling="yes" />
...
<%--
    <frameset rows="100,*,20" cols="*" framespacing="0" frameborder="0" border="0">
  <frame src="plexus_h.html" name="topFrame" scrolling="NO" noresize frameborder="0">

  <frameset  cols="175,*" frameborder="0" border="0" framespacing="0">
    <frame src="left_1.jsp" name="leftFrame" scrolling="NO" noresize frameborder="0">
<frame src="Controller?process=VisitProcess&action=viewTodaysAppointment&isPatientSelected=no" name="mainFrame" scrolling="YES">

  </frameset>

<frame src="footer2.html" scrolling="NO" noresize frameborder="0">
