<%--
    Document   : patientContactSearch
    Created on : Nov 13, 2015, 12:56:34 PM
    Author     : INTEL
--%>
...
<html >
        ...
        <script language="Javascript">
            ...
            function searchPatientByCondition()
            {
               // alert('select condition');
                ...
                {                   
                    //alert("You have selected patient search by card no");
                    searchPatientByCardNo();
                ...
                {
                   // alert("You have selected patient search by Name();");
                    searchByName();
                ...
                {
                   // alert("You have selected patient search by Mobile no");
                    searchByMobileNo();
                ...
                {
                   // alert("You have selected patient search by Text");
                    searchPatientByTextInput();
    ...
    <body>
        <form id="form1"  action="" method="POST" >
            <h3 style="background-image:url(images/header-bg.png);width:100%;color:#fff;text-align:center;padding: 8px 0px;margin: 0px;">Patient Search</h3>
            ...
            <div class="wrapper" ><!--wrapper started-->
                <div class="header_new">
                    <center><strong >Patient Search List </strong></center>
                </div>
        ...
        <script type="text/javascript">
            ...
            function searchByName(){
               ...
               // alert('search by contact searchByNamePrimarySecondary')
                form1.action="Controller?process=PatientProcess&action=searchByName&noOfRecords=20&pageno=1&alphabit=null";
                form1.submit();
            }
            ...
            function searchPatientByTextInput(){
               ...
               // alert('search by contact searchPatientByTextInput')
                form1.action="Controller?process=PatientProcess&action=searchPatientByText&noOfRecords=20&pageno=1&alphabit=null";
                form1.submit();
            }
