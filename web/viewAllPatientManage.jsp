<%-- 
    Document   : viewAllPatientManage
    Created on : Feb 2, 2016, 3:00:21 PM
    Author     : kamal
--%>
    ...
    <head >
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                if(!con)
                {
                    form1.action="viewAllPatientManage.jsp";
                }
                else
                    {
                        form1.action="Controller?process=PatientProcess&action=deleteMultiple";
                        form1.submit();
