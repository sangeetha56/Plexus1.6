<%-- 
    ...
    Created on : Jul 19, 2016, 3:55:43 PM
    Author     : kamal
--%>
        ...
        <div id="bord">
            <form name="form2" action="" method="post">
                <div style="overflow: hidden">
                    <table width="100%">
                        <tr>
                            <td  class="headerTD">Room View All</td>
                        </tr>
                        ...
                        <tbody>
                            <c:forEach items="${roomndBedSetUpList}" var="roomNdBedsetup">
                                ...
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    ...
                                    <td  class="dataTextInActive"><a  class="dataTextInActive"  href="Controller?process=RoomManagement&action=viewRoomDetail&id=<c:out  value='${roomNdBedsetup.roomndbedsetupid}'/>"><c:out value="${roomNdBedsetup.roomcode}"/></a></td>
