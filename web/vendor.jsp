...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function addVendor(){
                var form1=document.getElementById("form1");
                form1.action="Controller?process=VendorProcess&action=addVendor";
                form1.submit();
            }
            function addPatient(){
                var form1=document.getElementById("form1");
        ...
        <script language="Javascript">
            function validateFieldVendor()
            {
                if( document.getElementById("vendorName").value.length==0 )

                {
                    document.getElementById("vendorName").style.background='red';

                    alert("Enter the Vendor  name");

                }

                if( document.getElementById("vendorContactNo").value.length==0 )

                {
                    document.getElementById("vendorContactNo").style.background='red';

                    alert("Enter the Vendor  Contact No");
        ...
        <script language="Javascript">
            ...
            function valueExistsChangeColor()
            {
                ...
                {
                    document.getElementById("vendorName").style.background='white';
                ...
                {
                    document.getElementById("vendorContactNo").style.background='white';
    ...
    <body >
        <form id="form1"  action="Controller?process=VendorProcess&action=add" method="POST">
            <div style="height: 28px">
                ...
                <button id="add">Add Vendor</button>
                <br/>
            </div>
                    ...
                    <div id="effect" class="ui-widget-content ui-corner-all">
                        <div id="tabs">
                            ...
                            <div id="tabs-1">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="table1" style="display: block">
                                    <tr>
                                        ...
                                        <td width="35%"  >
                                            <label>
                                                <input name="vendorName" type="text" class="textField" id="vendorName" onkeypress="valueExistsChangeColor()" size="30"   >
                                            </label>
                                        </td>
                                    </tr>
                                    <tr><td><br/></td></tr>
                                    <tr>
                                        <td width="5%"  class="alignRight" >Representative Name &nbsp;  </td>
                                        <td width="35%"  >
                                            <label>
                                                <input name="representativeName" type="text" class="textField" id="representativeName" size="30"   >
                                            </label>
                                        </td>
                                    </tr>
                                    <tr><td><br/></td></tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%"  >
                                            <label>
                                                <input name="vendorContactNo" type="text" class="textField" id="vendorContactNo" size="30"   >
                                            </label>
                                        </td>
                                    </tr>
                                    <tr><td><br/></td></tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%" colspan="3" >
                                            <label>
                                                <textarea name="vendorAddress" cols="120" rows="5"  id="vendorAddress"></textarea>
                                            </label>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <table id="table2" width="100%" border="0" align="center"  >
                                ...
                                <tr>
                                    <td align="center">
                                        <button id="save" onmouseover="validateFieldVendor();">Save</button>
            ...
            <div style="overflow:scroll;height: 600px">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">Vendor View All</td>
                    </tr>
                </table>
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <thead >
                        <tr>
                            <th title="click to sort" class="headerText">Vendor Name<img  alt=" "  style="position:relative; top: 4px;  " src="images/sort_both.png" /></th>
                    ...
                    <tbody  >
                        <c:forEach items="${vendors}" var="vendor">
                            ...
                            <tr style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                <td  class="dataTextInActive" width="30%"><a  class="dataTextInActive"  href="Controller?process=VendorProcess&action=viewDetails&id=<c:out  value='${vendor.id}'/>"><c:out value="${vendor.name}"/></a></td>
