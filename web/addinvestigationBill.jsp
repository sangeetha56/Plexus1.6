<%--
    Document   : addinvestigationBill
    Created on : Aug 7, 2014, 2:32:46 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        $(function() {
            ...
            $(document).ready(function() {
                $("#investigationbilldate").val(getCurrentDate());
        ...
        <form id="form1"  action="" method="POST" >
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                    ...
                    <td><div align="right" class="style5">Investigation Bill Date</div></td>
                    <td><div align="right" class="style5">:</div></td>
                    <td><div align="left">
                            <label>
                                <input type="text" name="investigationbilldate" id="investigationbilldate" style="width: 100px" />
                            </label>
                        </div></td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="16%"><div align="left"><button id="addDossage">Add Investigation</button></div></td>
                    <td width="1%"><div align="left"></div></td>
            ...
            <TABLE id="dataTable" width="100%" border="0" >
                <thead>
                    <tr >
                        ...
                        <td class="headerText" width="31%">Investigation Type&nbsp;</td>
                        <td class="headerText" width="18%">Investigation Charges&nbsp;</td>
                        <td  width="28%">&nbsp;&nbsp;</td>
                        <td  width="13%">&nbsp;</td>
                        <td  width="6%">&nbsp;</td>
    ...
    function addInvestigationBill(){
        //alert('Hi for adding');
        var form1=document.getElementById("form1");
        form1.action="Controller?process=InvestigationBillProcess&action=add";
        form1.submit();
    }
