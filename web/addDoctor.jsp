<%-- 
    Document   : addDoctor
    Created on : May 19, 2014, 12:38:30 PM
    Author     : Admin
--%>
...
background-image: url();background-repeat: no-repeat;background-position: center;
        ...
        <script>
            ...
            function exist(exis)
            {
               for (var i=0; i<document.getElementById('doctornameexis').options.length; i++)
                {

                    if (document.getElementById('doctornameexis').options[i].text == exis)
                    {
                        alert('This Doctor Information  is Already Exist');
                        break;
                    }
                }
    ...
    <body >
        <div  id="bord" >
        <form id="form1"  action="Controller?process=DoctorProcess&action=add" method="POST" >
            <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add Doctor Information</span></div></td>
                </tr>
            </table>
                    ...
                    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="29%"><div align="left">
                                        <select style="width: 200px" name="doctid"  class="style7">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" onkeyup="exist(this.value);" name="doctrname" id="doctrname" style="width:200px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="doctrdesignation" id="doctrdesignation" style="width:200px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="doctrqualifaication" id="doctrqualifaication" style="width:200px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="doctremailid" id="doctremailid" style="width:200px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                            ...
                                            <td>
                                                <div align="left" >
                                                    <input type="text" name="doctrmobno" id="doctrmobno" style="width:200px" class="style7" />
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td><div align="left" style="display: none">
                                                    <select    name='doctornameexis' id="doctornameexis"  style="width:180px">
                                                        <option  value="none" >Select</option>
                                                        <%
                                                                    Class.forName("org.postgresql.Driver").newInstance();
                                                                     ...
                                                                     rs = stmt.executeQuery("Select * from doctorinfo");
                                                                    while (rs.next()) {
                                                        %>
