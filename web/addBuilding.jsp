<%-- 
    ...
    Created on : Jul 5, 2016, 12:37:43 PM
    Author     : INTEL
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
            ...
            function exist(exis)
            {
                for (var i=0; i<document.getElementById('consultantname').options.length; i++)
                {
                    ...
                    {
                        alert('This Building Type Information  is Already Exist');
                        break;
                    }
                }
        ...
        <script language="Javascript">
            ...
            {
                if( document.getElementById("BuildingBlockName").value.length==0 )

                {
                    document.getElementById("BuildingBlockName").style.background='red';

                    alert("Enter BuildingBlockName Name");
        ...
        <script language="Javascript">
            ...
            function valueExistsChangeColor()
            {
                ...
                {
                    document.getElementById("BuildingBlockName").style.background='white';
    ...
    <body >
        <div  id="bord" >
            <form id="form1"  action="" method="POST" >
                ...
                <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add New Building Type</span></div></td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                            <input type="text" onkeyup="exist(this.value);" name="BuildingBlockName" id="BuildingBlockName" onkeypress="valueExistsChangeColor()" style="width:180px" class="style7" />
                                        </div></td>
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                            <input type="text" name="NoOfFloors" id="NoOfFloors" style="width:180px" class="style7" />
                                        </div></td>
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                            ...
                            <script type="text/javascript">
                                ...
                                function addBuildingType(){
                                    //var country=document.getElementById("BuildingBlockName");

                                    var form1=document.getElementById("form1");
                                   
                                    form1.action="Controller?process=BuildingProcess&action=add";
                                    form1.submit();
