...
<html>
    <head>
        ...
        $(document).ready(function() {
                ...
                $("#dataTable").keyup(function(){
                    ...
                    totalpayafteradvanced=sum-advancedreceived;
                    ...
                    totaldue=receivedamount-totalvalueafterdiscount;
            ...
            <TABLE id="dataTable" width="100%" border="0" >
                ...
                <tfoot >
                    ...
                    <tr>
                        ...
                        <td height="24" align="center" style="width: 15%"><b><input type="text" name="advancedreceived" id="advancedreceived" value="0"  /></b></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="27" align="center" style="width: 15%"><b><input type="text" name="receivedamount" id="receivedamount" value="0"  /></b></td>
                    </tr>
    ...
    function addOperationBill(){
        //alert('Hi for adding');
        var form1=document.getElementById("form1");
        form1.action="Controller?process=OperationBillProcess&action=add";
        form1.submit();
    }
