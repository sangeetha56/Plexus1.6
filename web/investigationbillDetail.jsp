<%--
    Document   : investigationbillDetail
    Created on : Aug 8, 2014, 12:39:10 PM
    Author     : sultan
--%>
    ...
    <table  width="100%">
                <thead>
                    <tr  >
                        ...
                        <td colspan="3" class="headerText" style="color:#000">Investigation Bill Charges Details </td>
                ...
                <tbody>
                    <tr><td class="dataText" style="width: 45%">Invoice No: <c:out value="${investigationbill.investigationbillid}"/></td></tr>
                    <tr>
                        <td class="dataText" style="width: 45%">Patient Name: <c:out value="${investigationbill.patient.name}" /></td>
                        <td class="dataText" style="width: 20%">Contact No:  <c:out value="${investigationbill.patient.telephoneno}" /></td>
                        <td class="dataText">Visit Date: <fmt:formatDate pattern="dd MMMM yyyy " value="${investigationbill.investigationbilldate}" /> </td>

                    </tr>


                    <tr>
                        <td class="dataText" style="width: 45%">Card No: <c:out value="${investigationbill.patient.cardno}" /></td>
                        <td class="dataText" style="width: 30%">Doctor: <c:out value="${investigationbill.doctorinfo.doctname}" /></td><!-- dispense.dispensedmedicinebills.doctordepartment -->
                        <td class="dataText">Department :  <c:out value="${investigationbill.doctorinfo.departmentname.dptname}" /></td>
            ...
            <table width="100%">
               <thead>
                   <tr style="display: none" >
                        ...
                        <td  class="headerText">Investigation Bill Charges Details</td>
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                <thead>
                    <tr >
                        ...
                        <td class="headerText" style="color:#000">Investigation Type</td>
                        <td class="headerText" style="color:#000">Investigation Bill Charges</td>
                ...
                <tbody>
                     ...
                     <c:forEach items="${investigationbill.detailsinvestigationbills}" var="invest">

                        <tr>
                            <td class="dataText" align="center"><%=i%></td>
                            <td class="dataText" align="center"><c:out value="${invest.investigation.investigationtype}" /></td>
                            <td class="dataText" align="center"><c:out value="${invest.detailsinvestigationbillcharge}" /></td>
                            <td class="dataText" align="center"><c:out value="${invest.detailsinvestigationbillcharge}" /></td>
                ...
                <tfoot>
                        ...
                        <tr>
                            ...
                            <td class="dataText" align="center"><c:out value="${investigationbill.investigationbillcharges}" /></td>
                        </tr>
