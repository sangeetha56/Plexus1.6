...
*/
    ...
    <body>
        <script>
            $(document).ready(function() {
                ...
                $("#dispenseDate2day").val(getCurrentDate());
                $("#dispenseDate2day").datepicker();
                $("#show2day").button();
    ...
    function show2dateDispense(){
        ...
        var dateTodays=document.getElementById("dispenseDate2day").value;
        //alert(dateTodays);

        form1.action="Controller?process=DispenseProcess&action=showTodaysDispensedBills";
        form1.submit();
    ...
    function showBetweendateDispense(){
        ...
        form1.action="Controller?process=DispenseProcess&action=showBetweenTodaysDispensedBills";
        form1.submit();
    ...
    function showDispenseThisMonth(){
        ...
        form1.action="Controller?process=DispenseProcess&action=showDispensedBillsForThisMonth";
        form1.submit();
        ...
        <form id="form1" action="Controller?process=DispenseProcess&action=showDispensedBills" method="post">
            <table width="100%">
                <tr>
                    <td  colspan="2" class="headerTD" style="color:#000;">Summary of Pharmacy OutPatient Billing </td>
                </tr>
            </table>
      <%--          <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <td width="19%"><div align="left"></div></td>
        ...
        <td width="26%"><div align="left"></div></td>
                ...
                <tr>
                    <td  colspan="2" class="headerTD" style="color:#000;">Summary of Pharmacy OutPatient Billing for&nbsp;&nbsp;&nbsp;  <fmt:formatDate pattern="dd MMMM yyyy " value="${firstdate}" /> To <fmt:formatDate pattern="dd MMMM yyyy " value="${seconddate}" /> </td>
                </tr>
