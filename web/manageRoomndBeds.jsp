<%-- 
    Document   : manageRoomndBeds
    Created on : Jul 13, 2016, 11:40:30 AM
    Author     : kamal
--%>
...
%>
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                if(!con)
                {
                    form1.action="manageRoomndBeds.jsp";
                }
                else
                    {
                        form1.action="Controller?process=RoomManagement&action=deleteMultiple";
                        form1.submit();
        ...
        <div id="bord">
            <form name="form1" id="form1" action="" method="post">
                <div style="overflow: hidden">
                    <table width="100%">
                        <tr>
                            <td  class="headerTD">Manage Room and Bed Type </td>
                        </tr>
                        ...
                        <tbody>
                            <c:forEach items="${roomndBedSetUpList}" var="roomNdBedsetup">
                                ...
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    ...
                                    <td class="dataText"><input type="checkbox" id = "<c:out value="${roomNdBedsetup.roomndbedsetupid}"/>" class = "chcktbl"  name="patientIDs"  value="<c:out value="${roomNdBedsetup.roomndbedsetupid}"/>"/></td>
