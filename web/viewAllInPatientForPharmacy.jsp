<%--
    Document   : viewAll
    Created on : Dec 24, 2011, 3:13:33 PM
    Author     : Mayur
--%>
...
<html >
    ...
    <body  >
        ...
        <form name="form1" action="Controller?process=InPatientProcess&action=deleteMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">In-Patient List</td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <thead >
                        <tr  >
                            <th class="headerText"><input  type="hidden" id = "chckHead" /></th>
                            ...
                            <th title="click to sort" class="headerText">Telephone No&nbsp;&nbsp;&nbsp;</th>
                            <th title="click to sort" class="headerText">Admited Date</th>
                    ...
                    <tbody  >
                        ...
                        <c:forEach items="${inpatientList}" var="patient">
                               <c:if test="${patient.dischargedate==null}">
                            <c:set var="string" value="${patient.chiefcomplaints}"/>
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                <td class="dataText"><input type="checkbox" style="display: none" id = "<c:out value="${patient.id}"/>" class = "chcktbl"  name="patientIDs"  value="<c:out value="${patient.id}"/>"/></td>
                                <td  class="dataTextInActive"><a  class="dataTextInActive"><c:out value="${patient.cardno}"/></a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive"><c:out value="${patient.name}"/></a></td>
                    ...
                    <tfoot><tr>
                            <td style="display: none" class="footerTD" colspan="2" ><input value="delete" type="submit" id="delete"/></td>
                    </tr></tfoot>
