<%-- 
    ...
    Created on : Jul 5, 2016, 3:37:37 PM
    Author     : INTEL
--%>
    ...
    <head>
        ...
        <script>
            ...
            function exist(exis)
            {
                for (var i=0; i<document.getElementById('consultantname').options.length; i++)
                {
                    ...
                    {
                        alert('This room Type Information  is Already Exist');
                        break;
                    }
                }
        ...
        <script language="Javascript">
            function validateButton()
            {
                ...
                {
                    document.getElementById("RoomCode").style.background='red';

                    alert("Enter RoomCode Name");
    ...
    <body >
        <div  id="bord" >
            <form id="form1"  action="" method="POST" >
                ...
                <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add New Room Type</span></div></td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                            <input type="text" onkeyup="exist(this.value);" name="RoomType" id="RoomType" style="width:180px" class="style7" />
                                        </div></td>
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="RoomCharges" id="RoomCharges" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                                        ...
                                        <td><div align="left" style="display: none">
                                                <select    name='consultantname' id="consultantname"  style="width:180px">
                                                    ...
                                                    <%
                                                                ...
                                                                while (rs.next()) {
                                                    %>
                                                    <option id="productNameSearch" label="<%=rs.getString(3)%>" value="<%=rs.getString(1)%>"><%=rs.getString(3)%></option>
                                                    <%
                                                                }
                                                    %>
                            ...
                            <script type="text/javascript">
                                ...
                                function addRoomType(){
                                    ...
                                    form1.action="Controller?process=RoomProcess&action=add";
                                    form1.submit();
