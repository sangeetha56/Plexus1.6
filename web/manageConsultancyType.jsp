<%-- 
    Document   : manageConsultancyType
    Created on : Feb 18, 2016, 12:00:38 PM
    Author     : kamal
--%>
<%--
        ...
        <script type="text/javascript">
            function deleteRecords(){
                var form1=document.getElementById("form1");
                 ...
                 var con=false
                con=confirm('Do You Want To Dedelet Selected Consultncy Record');
                if(!con)
                {
                    form1.action="manageConsultancyType.jsp";
                }
                else
                    {
                        form1.action="Controller?process=ConsultancyProcess&action=deleteMultiple";
                        form1.submit();
            ...
            <form name="form1" id="form1" action="" method="post">
                <div style="overflow: hidden">
                    ...
                    <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                        ...
                        <tbody>
                            <c:forEach items="${consultancyList}" var="consultancy">

                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >

                                    <td class="dataText"><input type="checkbox" id = "<c:out value="${consultancy.consultancyid}"/>" class = "chcktbl"  name="patientIDs"  value="<c:out value="${consultancy.consultancyid}"/>"/></td>
                                    <td  class="dataTextInActive"><a  class="dataTextInActive"  href="Controller?process=ConsultancyProcess&action=viewDetails&id=<c:out  value='${consultancy.consultancyid}'/>"><c:out value="${consultancy.consultanttypename}"/></a></td>

                                    <td  class="dataText"><c:out value="${consultancy.cntlcycharges}"/></td>
