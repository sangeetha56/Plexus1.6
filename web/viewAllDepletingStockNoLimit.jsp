<%-- 
    Document   : viewAllDepletingStockNoLimit
    Created on : Feb 11, 2016, 1:41:20 PM
    Author     : kamal
--%>
        ...
        <form name="form1" id="form1" action="" method="post">
            <div class="wrapper"><!--wrapper started-->
                <div class="header_new">
                    <center><strong >Depleting Stock List </strong></center>
                </div>
             ...
             <div class="three" style="padding:0px 1px";>
                ...
                <div class="">
                    ...
                    <tbody  >
                        <c:forEach varStatus="count"  items="${depletingStocks}" var="stock"  >
 ...
 <br/>
           ...
           <script type="text/javascript">
                    ...
                    function CallFunction()
                    {
                        ...
                        form1.action="Controller?process=StockProcess&action=viewAllDepletingStockNoLimit&alphabit=null";
