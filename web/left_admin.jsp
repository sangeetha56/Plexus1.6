...
<html>
    ...
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <h5 style="font-size: 12px"><a href="#" >User Information</a></h5>
            <div>
                <a target="mainFrame" href="Controller?process=UserProcess&action=viewAllUsers">List All Users</a><br/>
                <hr>
                <a target="mainFrame" href="Controller?process=UserProcess&action=addnewuser">Add New User</a><br/>

            </div>

            <h5 style="font-size: 12px"><a href="#" >Room & Bed Information</a></h5>
            <div>
                <a target="mainFrame" href="Controller?process=RoomManagement&action=viewAllRooms">List All Rooms</a><br/>
                <hr>
                <a target="mainFrame" href="Controller?process=BedManagement&action=viewAllBed">Search</a><br/><!-- bedSearch.jsp -->
                <hr>
 ...
 <hr>
                ...
                <a target="mainFrame" href="Controller?process=TherapyBillProcess&action=showTodaysTherapyBills">Consultancy</a><br/>
                 <hr>
                ...
                <a target="mainFrame" href="Controller?process=InvestigationBillProcess&action=showTodaysInvestigationBills">Investigation</a><br/>
                 <hr>
                  <a target="mainFrame" href="Controller?process=AdvanceProcess&action=showTodaysAdvanceBills">Advance</a><br/>
                 <hr>
                 <a target="mainFrame" href="Controller?process=OperationBillProcess&action=showTodaysOperationBills">Hopital</a><br/>
                 <hr>
           ...
           <%--  <a target="mainFrame" href="consultancyTab.jsp">Consultancy</a><br/>
                 ...
                 <a target="mainFrame" href="biochemistry.jsp">Biochemistry</a><br/>
                 <hr>
                 <a target="mainFrame" href="lab.jsp">Lab</a><br/>
                 <hr>
                 <a target="mainFrame" href="bloodtransfucion.jsp">Blood Transfucion</a><br/>
                 <hr>
                 <a target="mainFrame" href="bbiochemistry.jsp">Biochemistry</a><br/>
                 <hr>
                  <a target="mainFrame" href="routineurine.jsp">Routineurine Examination</a><br/>
                 <hr>
              ...
              <%--  <a target="mainFrame" href="manageDepartment.jsp">Department Type</a><br/> --%>
                ...
                <a target="mainFrame" href="Controller?process=TherapyProcess&action=viewAll">View Therapy Type</a><br/>--%>
                 <a target="mainFrame" href="therapy.jsp">Consultancy</a><br/>
                <hr>
                 <a target="mainFrame" href="InvestigationTab.jsp">Investigation</a><br/>
                 <hr>
                 <a target="mainFrame" href="OperationTab.jsp">Bill</a><br/>
         ...
         <!--       <a target="mainFrame" href="addLicenceInfo.jsp">Add Info</a><br/>
            ...
            <h5 style="font-size: 12px"><a href="#" >Token System</a></h5>
            <div>
                <a target="mainFrame" href="Controller?process=TokenSystemProcess&action=issueToken">Issue Token</a><br/> <!-- Controller?process=TokenSystemProcess&action=issueToken    issueToken.jsp-->
                 <hr>

                 <a target="mainFrame" href="tokenReport.jsp">Token Report</a><br/> <!-- Controller?process=TokenSystemProcess&action=issueToken    issueToken.jsp-->
                 <hr>
         <!--       <a target="mainFrame" href="addLicenceInfo.jsp">Add Info</a><br/>
                 <hr>
                 <a target="mainFrame" href="Controller?process=LicenceProcess&action=viewLicence">View Licence</a><br/>
