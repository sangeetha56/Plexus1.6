<%-- 
    Document   : myinContactsPopup
    Created on : Mar 30, 2016, 1:02:02 PM
    Author     : kamal
--%>
...
<script type="text/javascript">
            ...
            function writeName(id,name) {
               ...
               // alert("opener values are:-"+opener.fName);
                opener.form1.inpatientId.value = id;
                opener.form1.inpatientName.value = name;
                    ...
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${inpatientList}" var="patient">
                                ...
                                <tr class="trClass"  >
                                     <td class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.id}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.cardno}"/></td>
                                    <td class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out  value="${patient.name}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.telephoneno}"/></td>
