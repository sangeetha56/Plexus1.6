<%-- 
    Document   : myContactsPopupForBiochemistry
    Created on : Aug 5, 2017, 8:54:10 PM
    Author     : Admin
--%>
...
%>
        ...
        <script type="text/javascript">
            ...
            function writeName(id,name,age,sex,cardno) {
               ...
               // alert("opener values are:-"+opener.fName);
                ...
                opener.form1.patientName.value = name;
                 opener.form1.Age.value = age;
                 opener.form1.Sex.value = sex;
                    ...
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${patientList}" var="patient">
                                ...
                                <tr class="trClass"  >
                                    <td class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.age}"/>','<c:out value="${patient.sex}"/>','<c:out value="${patient.cardno}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.id}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.age}"/>','<c:out value="${patient.sex}"/>','<c:out value="${patient.cardno}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.cardno}"/></td>
                                    <td class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.age}"/>','<c:out value="${patient.sex}"/>','<c:out value="${patient.cardno}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out  value="${patient.name}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${patient.id}"/>','<c:out value="${patient.name}"/>','<c:out value="${patient.age}"/>','<c:out value="${patient.sex}"/>','<c:out value="${patient.cardno}"/>')" style="cursor: pointer;" title="Click to attach this patient"><c:out value="${patient.telephoneno}"/></td>
