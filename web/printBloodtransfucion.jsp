...
<script src="js/print/jquery-1.7.2.min.js" type="text/javascript"></script>
    ...
    <script>
            function reformatDate() {
                ...
                if(document.getElementById("bdate").value!='')
                {
                    ...
                    var dateF=document.getElementById("bdate");
                    var arry= new Array();
                    //    var arry1= new Array();
                    var year=new Array();
                    var month=new Array();
    ...
    <script type="text/javascript">
            function callFinalPage()
            {
                ...
                window.location="Controller?process=BloodtransfucionProcess&action=add";
            }
    ...
    <form id="form1"  action="" method="POST" >
        ...
        <div class="login-form" style="background-color: #cad8e3;width:50%;border: ridge" id="printData" >
            <table width="100%" align="center">
                <tr>
                    <td align="center">
                        <h1 style="color: black;font-family:Agency FB;font-size: 20px"><b>Print Bloodtransfucion</b></h1>
                    </td>
                </tr>
            ...
            <table width="50%" align="center">
                ...
                <tr>
                    <td align="center">
                       Patient Name: <input type="text" name="patientname" id="patientname" value="<c:out value="${patientname}" />" placeholder="Token" size="5"  style="text-align: center;" readonly>
                    </td>
                </tr>
                <tr>
                    <td align="center">
