    ...
    <body>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#advanceDate2day").val(getCurrentDate());
                $("#advanceDate2day").datepicker();
                $("#show2day").button();
        ...
        <script type="text/javascript">
            $(function() {
                ...
                .button()
                .click(function() {
                    showBetweendateAdvanceBill();

                });
                $( "#thismonth" )
                .button()
                .click(function() {
                    showAdvanceThisMonthBill();
        ...
        <script type="text/javascript">
            function show2dateAdvance(){

                //alert('llll');

                var form1=document.getElementById("form1");
                var dateTodays=document.getElementById("advancebilldate").value;
                //alert(dateTodays);

                form1.action="Controller?process=AdvanceProcess&action=showTodaysAdvanceBills";
                form1.submit();

            }

            function showBetweendateAdvanceBill(){

                //alert('2222llll');

                var form1=document.getElementById("form1");

                form1.action="Controller?process=AdvanceProcess&action=showBetweendateAdvanceBill";
                form1.submit();

            }

            function showAdvanceThisMonthBill(){

                //alert('showDispenseThisMonth');

                var form1=document.getElementById("form1");

                form1.action="Controller?process=AdvanceProcess&action=showAdvanceThisMonthBill";
                form1.submit();
        ...
        <form id="form1" action="Controller?process=AdvanceProcess&action=showAdvanceBillsByDate" method="post">
            <table width="100%">
                <tr>
                    <td  class="headerTD" style="color:#000;">Advance Bill View All</td>
                </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="7%"><div align="left">
                                        <label>
                                            <input type="text" name="advancebilldate" id="advancebilldate" size="10" />
                                        </label>
                                    </div></td>
                ...
                <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td width="7%"><div align="left">
                                    <label>
                                        <input style="display: none" type="text"  name="advanceDate2day" id="advanceDate2day" />
                                    </label>
                                </div></td>
                            <td width="11%"><div align="left"></div></td>
                            <td width="13%"><div align="left"></div></td>
            ...
            <table  width="100%"   id="" border="1">
                <tr>
                    <td  colspan="2" class="headerTD" style="color:#000;">Summary of Advance Billing for&nbsp;&nbsp;&nbsp;  <fmt:formatDate pattern="dd MMMM yyyy " value="${firstdate}" /> To <fmt:formatDate pattern="dd MMMM yyyy " value="${seconddate}" />  </td>
                </tr>
                            ...
                            <table  width="100%"   id="myTable" border="1">
                                ...
                                <thead>
                                    <tr class="headerText" >
                                        ...
                                        <th  style="color:#000;">Advance</th>
                                        <th  style="color:#000;">Visit Date</th>
                                        <th style="color:#000;" >Balance Amount</th>
                                ...
                                <tbody >
                                    ...
                                    <c:forEach items="${advance}" var="advance">
                                        <tr style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                            <td class="dataText"  ><%=i%></td>
                                            <td class="dataText"  ><c:out value="${advance.patient.name}"/></td>
                                            <td class="dataText"  ><c:out value="${advance.advanceamount}"/></td>


                                            <td class="dataText"  ><fmt:formatDate pattern="dd-MM-yyyy " value="${advance.advancebilldate}" /> </td>
                                            <td class="dataText"  ><c:out value="${advance.paid}"/></td>
                                ...
                                <tfoot>
                                    <c:forEach items="${advance}" var="advance">
                                        <tr >
                                            ...
                                            <td class="headerTDLastRow" align="center" colspan="2"><c:out value="${advance.totalbill}" /></td>
                                        </tr>
                    ...
                    <td width="12%"><div>
                            ...
                            <table  width="100%"   id="myTable" border="1">
                                ...
                                <tbody >
                                    ...
                                    <c:forEach items="${advance}" var="advance">
                                        <tr style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                            <td class="dataText" ><a href="Controller?process=AdvanceProcess&action=showAdvanceBillByIdToAddMore&id=<c:out value="${advance.advancebillid}"/>">Add</a>&nbsp;&nbsp;<a href="Controller?process=AdvanceProcess&action=showAdvanceBillById&id=<c:out value="${advance.advancebillid}"/>">Preview</a>&nbsp;<a  href="Controller?process=AdvanceProcess&action=printAdvanceCharge&id=<c:out value="${advance.advancebillid}"/>">Print!</a></td>
