<%-- 
    ...
    Created on : Mar 30, 2016, 4:47:31 PM
    Author     : kamal
--%>
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${medicines}" var="crrentstock">
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    ...
                                    <td  class="dataText"><a class="dataTextActiveEmpty" href="Controller?process=MedicineProcess&action=viewMedicineDetails&id=<c:out value="${crrentstock.id}" />"><c:out value="${crrentstock.name}"/></a></td>
