        ...
        <form action="Controller?process=RedispenseProcess&action=add" method="post" onsubmit="return validateMedicine()">
            <table  width="100%">
                ...
                <tbody>
                    ...
                    <tr><td style="width: 45%">Invoice No: <c:out value="${redispensedmedicinebill.id}"/></td></tr>
                      </c:forEach>
                    <tr>
                        <td style="width: 45%">Patient Name: <c:out value="${redispense.patient.name}" /></td>
                        <td style="width: 20%">Contact No:  <c:out value="${redispense.patient.telephoneno}" /></td>
                        <td>Dispense Date: <fmt:formatDate pattern="dd MMMM yyyy " value="${redispense.dispensedate}" /> </td>

                    </tr>

                        <c:forEach end="1" items="${redispense.redispensedmedicinebills}" var="redispensedmedicinebill">
                    <tr>
                        <td style="width: 45%">Card No: <c:out value="${redispense.patient.cardno}"/></td>
                        <td style="width: 30%">Doctor: <c:out value="${redispensedmedicinebill.doctorname}" /></td><!-- dispense.dispensedmedicinebills.doctordepartment -->
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tbody>
                    ...
                    <c:forEach items="${redispense.reunitdispensedoses}" var="reunitdispensedose">
                        ...
                        <tr>
                            ...
                            <td align="center"><c:out value="${reunitdispensedose.medicine.name}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.medicine.batchno}" /></td>

                            <td align="center"><c:out value="${reunitdispensedose.medicine.expirydatemedicine}" /></td>

                            <td align="center"><c:out value="${reunitdispensedose.quantity}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.medicine.price}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.medicine.cgst}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.medicine.sgst}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.medicine.igst}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.medicine.gst}" /></td>
                            <td align="center"><c:out value="${reunitdispensedose.amount}" /></td>
                ...
                <tfoot>
                 ...
                 <tr>
                        ...
                        <td align="center" style="width: 15%"><c:out value="${redispensedmedicinebill.medicineamount}" /></td>
                    </tr>
                    <tr>
                        <td colspan="10" height="24" style="border:hidden">&nbsp;</td>
                        <td height="24" align="right">Bill Value</td>
                        <td height="24" align="center" style="width: 15%"><c:out value="${redispensedmedicinebill.medicineamount}" /></td>
                    </tr>
                 ...
                 <%--   <tr>
                    ...
                    <tr>
                        ...
                        <td height="22" align="center" style="width: 15%"><c:out value="${redispensedmedicinebill.discountparcentage}" /></td>
                    </tr>

                    <tr>
                        <td colspan="10" height="27" style="border:hidden">&nbsp;</td>
                        <td height="27" align="right">Discount Amount(-)</td>
                        <td height="27" align="center" style="width: 15%"><c:out value="${redispensedmedicinebill.discountedvalue}" /></td>
                    </tr>

                    <tr>
                        <td colspan="10" height="27" style="border:hidden">&nbsp;</td>
                        <td height="27" align="right">Total Payable</td>
                        <td height="27" align="center" style="width: 15%"><c:out value="${redispensedmedicinebill.amount}" /></td>
                    </tr>
                    </c:forEach>
            ...
            <table id="dataTable" width="100%" border="0">
                <tr>
                    <td align="center" >
                        ...
                        <a id="print" href="Controller?process=RedispenseProcess&action=printBill&id=<c:out value="${redispense.id}"/>">Print</a>
