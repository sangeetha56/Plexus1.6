<%-- 
    Document   : addMedicine_JQUERY
    Created on : Jun 12, 2014, 2:18:01 PM
    Author     : sultan
--%>
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .header_new
            {
                background:#4b6a84; padding:5px 5px; color: #fff; font-size: 15px;
            }
        ...
        <script language="Javascript">
            function validateFieldMedicine()
            {
                ...
                if( document.getElementById("unitPrice").value.length==0 )

                {
                    document.getElementById("unitPrice").style.background='white';

                    alert("Enter the Medicine  Price");
    ...
    <body >
        <form id="form1"  action="Controller?process=PatientProcess&action=add" method="POST">
                            ...
                            <div id="tabs-1">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="table1" style="display: block">
                                    <tr>
                                        ...
                                        <td width="28%"  >
                                            <label>
                                                <input name="name" type="text" class="textField" id="name" onkeypress="valueExistsChangeColor()" size="30"   >
                                            </label>
                                        </td>
                                        <td width="16%"  class="alignRight" >Strength &nbsp;  </td>
                                        <td width="28%"  >
                                            <label>
                                                <input name="strength" type="text" class="textField" id="strength" size="30"   >
                                            </label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="price" type="text" class="textField" id="price" size="30" >
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <label>
                                                <input  name="unitQuantity" type="text" class="textField" id="unitQuantity" size="30"  onblur="calculateUnitPrice();">
                                            </label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr></tr>
                                    <tr>
                                        <td class="alignRight">License No&nbsp;
                                        </td>
                                        <td>
                                            <label>
                                        ...
                                        <td>
                                            <label>
                                                <input readonly name="unitPrice" type="text" class="textField" id="unitPrice" onkeypress="valueExistsChangeColor()" size="30" >
                                            </label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input  name="cgst" id="cgst" type="text" class="textField"  size="28" >
                                                <input disabled="true"  type="text" class="textField" value="%"  size="2" >
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <label>
                                                <input  name="sgst" id="sgst" type="text" class="textField"  size="28" >
                                                <input disabled="true"  type="text" class="textField" value="%"  size="2" >
                                            </label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input  name="igst" id="igst" type="text" class="textField"  size="28" >
                                                <input disabled="true"  type="text" class="textField" value="%"  size="2" >
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <label>
                                                <input  name="gst" id="gst" type="text" class="textField"  size="28" >
                                                <input disabled="true"  type="text" class="textField" value="%"  size="2" >
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input  name="companyName" type="text" class="textField" id="companyName" readonly onclick="openPopup1()"  size="30" >
                                        ...
                                        <td>
                                            <label>
                                                <input  name="vendorName" type="text" class="textField" id="vendorName" readonly onclick="openPopup()"   size="30" >
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <label>
                                                <textarea name="remarks" cols="120" rows="4"  id="remarks"></textarea>
                                            </label>
                                        </td>
                                    </tr>
