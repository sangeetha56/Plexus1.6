<%-- 
    Document   : addTherapyType
    Created on : Aug 12, 2014, 5:44:09 PM
    Author     : sultan
--%>
               ...
               for (var i=0; i<document.getElementById('consultantname').options.length; i++)
                {
                    ...
                    {
                        alert('This Therapy Type Information  is Already Exist');
                        break;
                    }
                }
        ...
        <form name="form1" id="form1"  action="" method="POST" >
            <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add Consultancy Type Information</span></div></td>
                </tr>
            </table>
                ...
                <tr>
                    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" onkeyup="exist(this.value);" name="therapytypename" id="therapytypename" onkeypress="valueExistsChangeColor()" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" name="TherapyTypeCharges" id="TherapyTypeCharges" style="width:180px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
         ...
         <script type="text/javascript">
          ...
          var country=document.getElementById("therapytypename");
