<%--
    Document   : MedicineSearch
    Created on : Jan 4, 2016, 1:22:22 PM
    Author     : INTEL
--%>
...
<html >
            ...
            <%--   function searchPatientByMobileNo()
                {
                    ...
                    function searchMedicineByCondition()
                    {
                       // alert('select condition');
                        if( document.getElementById("primaryName").value.length!=0 && document.getElementById("byText").value.length==0 )

                        {
                            alert("You have selected Medicine search by Name");
                            searchMedicineByName();

                        }

                        else if( document.getElementById("byText").value.length!=0 && document.getElementById("primaryName").value.length==0 )

                        {
                            alert("You have selected Medicine search by Text");
                            searchPatientByTextInput();
    ...
    <body>
        <form id="form1"  action="" method="POST" >
            <h3 style="background-image:url(images/header-bg.png);width:100%;color:#fff;text-align:center;padding: 8px 0px;margin: 0px;">Medicine Search</h3>
            <table style="width:100%;">
                <tr style="width:1000px;" align="center">
                    <td style="width:50%;">By  Name  : <input type="text"  type="text" name="primaryName" id="primaryName" value="" onclick="flashOldValues();" style="margin-bottom: 10px;margin-top: 10px;">
                        <input type="hidden" value="Search" id="searchMedicineByName" name="searchMedicineByName" onclick="return searchByName();" class="ui-button-text" style="padding: 0.2em 1em;"></td>
                    <td style="width:50%;">By Text: <input type="text" name="byText" id="byText" value="" onclick="flashOldValues();" style="margin-bottom: 10px;margin-top: 10px;">
                        <input type="hidden" value="Search" id="searchByText" name="searchByText" onclick="return searchPatientByTEXT();" class="ui-button-text" style="padding: 0.2em 1em;"></td>
                </tr>

                <tr style="width:1000px;" align="center">
                    <td style="width:100%;" colspan="2">
                        <input type="button" value="Search" id="" name="" onclick="return searchMedicineByCondition();" class="ui-button-text" style="padding: 0.2em 1em;background-color: #EAF4FD;">
            ...
            <div class="wrapper"><!--wrapper started-->
                <div class="header_new">
                    <center><strong >Medicine Search List </strong></center>
                </div>
                    ...
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${medicines}" var="medicine">
                                <c:if test="${medicine.usable eq true}">
        ...
        <script type="text/javascript">
            ...
            <%--  function searchPatientByCardNo(){
                ...
                var form1=document.getElementById("form1");
                alert('search by cardno type1');
                form1.action="Controller?process=PatientProcess&action=searchPatientByCardNo&noOfRecords=20&pageno=1&alphabit=null";
                form1.submit();
            }--%>
                    ...
                    function searchMedicineByName(){
                        //alert("search1");
                        var form1=document.getElementById("form1");
                      //  alert('search by contact searchByNamePrimarySecondary')
                        form1.action="Controller?process=MedicineProcess&action=searchMedicineByName&noOfRecords=20&pageno=1&alphabit=null";
                        form1.submit();
                    }
            ...
            <%--  function searchByMobileNo(){
                ...
                var form1=document.getElementById("form1");
                alert('search by MobileNo type1');
                form1.action="Controller?process=PatientProcess&action=searchByMobileNo&noOfRecords=20&pageno=1&alphabit=null";
                form1.submit();
            }--%>

                    function searchPatientByTextInput(){
                        var form1=document.getElementById("form1");
                       // alert('search by contact searchPatientByTextInput')
                        form1.action="Controller?process=MedicineProcess&action=searchMedicineByText&noOfRecords=20&pageno=1&alphabit=null";
                        form1.submit();
                    }
