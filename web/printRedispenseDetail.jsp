...
<html>
    ...
    <body style="text-align: center">
        <form action="Controller?process=RedispenseProcess&action=add" method="post" onsubmit="return validateMedicine()">
            <br>
            <br>
            <br><br>
            ...
            <table  width="100%"  style="border-collapse:collapse;" align="left">
               ...
               <tbody>
                    <c:forEach end="1" items="${redispense.redispensedmedicinebills}" var="redispensedmedicinebill">
                    <tr><td style="width: 45%" align="left">Invoice No: <c:out value="${redispensedmedicinebill.id}"/></td></tr>
                      </c:forEach>
                    <tr>
                        <td style="width: 40%" align="left">Patient Name: <c:out value="${redispense.patient.name}" /></td>
                        <td style="width: 30%" align="left">Contact No: <c:out value="${redispense.patient.telephoneno}" /></td>
                        <td style="width: 30%" align="right">Date: <fmt:formatDate pattern="dd MMMM yyyy " value="${redispense.dispensedate}" /> </td>

                    </tr>

                        <c:forEach end="1" items="${redispense.redispensedmedicinebills}" var="redispensedmedicinebill">
                     <tr>
                         <td style="width: 45%" align="left">Card No: <c:out value="${redispense.patient.cardno}"/></td>
                         <td style="width: 30%" align="left">Doctor: <c:out value="${redispensedmedicinebill.doctorname}" /></td><!-- dispense.dispensedmedicinebills.doctordepartment -->
                        <td >Department :  <c:out value="${redispensedmedicinebill.doctordepartment}" /></td>
                ...
                <tbody align="left">
                     <%
                            int i=1;
                     %>
                    <c:forEach items="${redispense.reunitdispensedoses}" var="reunitdispensedose">
                        <tr>
                            <td align="center" style="font-size: 12px"><%=i%></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.name}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.batchno}" /></td>

                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.expirydatemedicine}" /></td>

                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.quantity}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.price}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.cgst}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.sgst}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.igst}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.medicine.gst}" /></td>
                            <td align="center" style="font-size: 12px"><c:out value="${reunitdispensedose.amount}" /></td>
                            <c:set var="quantity" value="${reunitdispensedose.quantity}"/>
                            <c:set var="price" value="${reunitdispensedose.medicine.price}"/>
                            <c:set var="gst" value="${reunitdispensedose.medicine.gst}"/>
                             <%
               ...
               <tfoot>
                  ...
                  <tr>
                        ...
                        <td align="center" style="width: 15%;font-size: 12px" ><c:out value="${redispensedmedicinebill.medicineamount}" /></td>
                    </tr>
                    <tr>
                        <td colspan="10" height="10" style="border:hidden">&nbsp;</td>
                        <td height="10" align="right" style="font-size: 12px">Bill Value</td>
                        <td height="10" align="center" style="width: 15%;font-size: 12px"><c:out value="${redispensedmedicinebill.medicineamount}" /></td>
                    </tr>
                    <tr>
                        <td colspan="10" height="24" style="border:hidden">&nbsp;</td>
                        <td height="24" align="right">Total Tax&nbsp;&nbsp;</td>
                        <td height="24" align="center" style="width: 15%"><c:out value="${redispensedmedicinebill.totaltaxvalue}" /></td>
                    ...
                    <tr>
                        ...
                        <td height="10" align="center" style="width: 15%;font-size: 12px"><c:out value="${redispensedmedicinebill.discountparcentage}" /></td>
                    </tr>

                    <tr>
                        <td colspan="10" height="10" style="border:hidden">&nbsp;</td>
                        <td height="10" align="right" style="font-size: 12px">Discount Amount(-)</td>
                        <td height="10" align="center" style="width: 15%;font-size: 12px"><c:out value="${redispensedmedicinebill.discountedvalue}" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="10" align="center" style="width: 15%;font-size: 12px"><c:out value="${redispensedmedicinebill.amount}" /></td>
                    </tr>
