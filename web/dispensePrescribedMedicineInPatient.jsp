...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function calculateGrandTotal() {
                ...
                $('#grandTotalAmountinPatient').val(sum.toPrecision(6));

            }
            $(document).ready(function() {
                $("#dispenseDateInpatient").val(getCurrentDate());
                $("#dispenseDateInpatient").datepicker();

           /*     $("#consultationamountinPatient").keyup(function(){
                    var consultation=parseFloat($("#consultationamountinPatient").val());
                    var miscellanous=parseFloat($("#miscellanousamountinPatient").val());
                    var sum = 0.0;
                    var totalSum=0.0;
                    var column2 = $('.medicineAmount')
                    jQuery.each(column2,function(){
                    ...
                    $('#grandTotalAmountinPatient').val(totalSum.toPrecision(6));

                });
        */
                 $("#miscellanousamountinPatient").keyup(function(){
                     //var consultation=parseFloat($("#consultationamountinPatient").val());
                    var miscellanous=parseFloat($("#miscellanousamountinPatient").val());
                    var sum = 0.0;
                    var totalSum=0.0;
                ...
                $("#dataTableInpatient").keyup(function(){
                    //var consultation=parseFloat($("#consultationamountinPatient").val());
                    var miscellanous=parseFloat($("#miscellanousamountinPatient").val());
                    var discount=parseFloat($("#discountparcentinPatient").val());
                    ...
                    $('#medicineTotalAmountinPatient').val(sum.toPrecision(6));
                    $('#grandTotalAmountinPatient').val(totalSum.toPrecision(6));
                    $('#discountamountinPatient').val(discountedamount.toPrecision(6));
                    $('#totalvalueinPatient').val(totalvalueafterdiscount.toPrecision(6));
            ...
            var inpatients=[
            <c:forEach varStatus="status" items="${inpatientList}" var="inpatient">{
                value:'<c:out default="0" value="${inpatient.name}" />',
                id:'<c:out default="0" value="${inpatient.id}" />',
                cardno:'<c:out default="0" value="${inpatient.cardno}" />'
            }<c:if test="${!status.last}">,</c:if>
            </c:forEach>
        ];
        $(function() {
            $( "#inpatientName").autocomplete({
                source: inpatients,
                minLength: 1,
                change:function(event,ui){
                    $( "#inpatientId").val( ui.item.id );
                },
            ...
            var addDossageButtonID="#addDossageinPatient";
            var removeDossageButtonID="#removeDossageinPatient";
            $( addDossageButtonID )
            .button({
                icons: {
        ...
        function addRow() {
            var rowCount = document.getElementById('dataTableInpatient').rows.length;
            ...
            var col4="<td class='dataTextInActive'><input type='text' value='0' onclick='calculate("+rowCount+")'  onkeyup='calculate("+rowCount+")' name='medicineQuantities' id=medicine_quantity_"+rowCount+" size='5'/><input type='hidden'   id=hiddenMedicine_quantity_"+rowCount+" value='' /></td>";
            ...
            var col8="<td class='dataTextInActive' ><input class='' type='text' value='0' readonly name='medivat' id=Medicine_vat_"+rowCount+" size='10'/></td>";
            var col9="<td class='dataTextInActive' ><input class='' type='text' value='0' readonly name='medicgst' id=Medicine_cgst_"+rowCount+" size='10'/></td>";
            var col10="<td class='dataTextInActive' ><input class='' type='text' value='0' readonly name='medisgst' id=Medicine_sgst_"+rowCount+" size='10'/></td>";
            var col11="<td class='dataTextInActive' ><input class='' type='text' value='0' readonly name='mediigst' id=Medicine_igst_"+rowCount+" size='10'/></td>";
            ...
            var newRow = $("<tr class='trClass'>"+col1+col2+col6+col7+col4+col3+col9+col10+col11+col12+col5+col13+"</tr>");
            $(function() {
                $("#dataTableInpatient").find('tbody').append(newRow);
            });
            $(function() {
  ...
  <script>
            function callInpatientList()
            {
              //  alert('hi');
          //action="Controller?process=InPatientProcess&action=viewAll";
          window.location.href="Controller?process=InPatientProcess&action=viewAllPharmacyInpatientList";
           //  var button1=document.getElementById("loadInPatient");
             //   button1.action="Controller?process=InPatientProcess&action=viewAllPharmacyInpatientList";
              //  button1.submit();
            }
            </script>
        ...
        //  alert(a.innerHTML);
            ...
            //-----------------------------------------END----------------------------------------------------------------
                ...
                <script type="text/javascript">
            jQuery(function($){
                $("#inpatientName").Watermark("Click here to select patient");
    ...
    <body>
        <form action="Controller?process=inDispenseProcess&action=add" name="form1" id="form1" method="post" onsubmit="return validate()">

            <table  width="100%">
            <!--    <button id="loadInPatient" onclick="callInpatientList();">Load In-Patient</button> -->
                <thead>
                    <tr>
                        <th colspan="8" class="headerTD"> Dispense Medicine In Patient</th>
...
<%--
                    <tr>
                        <td style="width: 45%">In-Patient Name: <input  type="text" name="inpatientName" id="inpatientName" style="width: 200px" /> <input name="inpatientId" type="hidden" id="inpatientId" value="" /> </td>
                        <td>Dispense Date: <input type="text" name="dispenseDateInpatient" id="dispenseDateInpatient" /></td>
                    <!--    <td>Dossage: <button id="addDossageinPatient">Add</button>&nbsp;&nbsp;&nbsp;<button id="removeDossageinPatient">Remove</button></td> -->
                    ...
                    <tr>
                        ...
                        <td style="width: 45%; display: none">Consultation &nbsp;&nbsp;&nbsp;<input  type="text" name="consultationamountinPatient" id="consultationamountinPatient" style="width: 200px" value="0" />  </td>
                        <td><button id="addDossageinPatient">Add Medicine</button>
                            Miscellaneous &nbsp;&nbsp;&nbsp; <input type="text" name="miscellanousamountinPatient" id="miscellanousamountinPatient" value="0" /></td>

                             <td><div align="right"><span class="">Department Name</span></div></td>
                                <td>:</td>
                                <td><div align="left">

                                          <select style="width: 100px" class="textField" name='countryIDk' id="countryIDk"  onchange="showState(this.value)">
                                ...
                                <td>:</td>
                                <td><div align="right" id='statek'>
                                         <select style="width: 100px" class="textField" name='statek'>
                    ...
                    <tr>
                           <input type="text" name="countrynameTxtk" id="countrynameTxtk" value="null" size="10" />
                           <input type="text" name="statenameTxtk" id="statenameTxtk" value="null" size="10" />
                    </tr>
...
--%>
      ...
      <tr>
        ...
        <td width="28%"><div align="left">
          <label>
              ...
              <a id="contPopup"  href="javascript:openWin5('Controller?process=InPatientProcess&action=viewAllPopUp&patientControllerValue=null&noOfRecords=20&pageno=1&alphabit=null&flag=0',700,300,'propAdd1')"    style="font-size:7pt;" class="anchor" ><input  type="text" name="inpatientName" id="inpatientName" style="width: 200px" title="Click here to Select Patient" /></a> <input name="inpatientId" type="hidden" id="inpatientId" value="" />
          </label>
        </div></td>
        ...
        <td width="41%"><div align="left">
          <label>
          <input type="text" name="dispenseDateInpatient" id="dispenseDateInpatient" />
          </label>
        </div></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="16%"><div align="left"><button id="addDossageinPatient">Add Medicine</button></div></td>
        <td width="1%"><div align="left"></div></td>
        <td width="28%"><div align="left"></div></td>
        ...
        <td width="41%"><div align="left">
          <label>
          <input type="hidden" name="miscellanousamountinPatient" id="miscellanousamountinPatient" value="0" />
          </label>
        </div></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="41%"><div align="left">
                <label>
                    <input type="hidden" name="countrynameTxtk" id="countrynameTxtk" value="null" size="10" />
                           <input type="hidden" name="statenameTxtk" id="statenameTxtk" value="null" size="10" />
                </label>
            </div></td>
      </tr>
    </table></td>
            ...
            <TABLE id="dataTableInpatient" width="100%" border="1" >
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="text" name="medicineTotalAmountinPatient" id="medicineTotalAmountinPatient" value="0" readonly /></td>
                    </tr>
                    <tr>

                        <td colspan="7" align="right"><b>Bill Value&nbsp;&nbsp;</b></td>
                        <td align="center"><b><input type="text" name="grandTotalAmountinPatient" id="grandTotalAmountinPatient" value="0" readonly /></b></td>
                    </tr>
                    <tr>

                        <td colspan="7" align="right"><b>Discount&nbsp;&nbsp;</b></td>
                        <td align="center"><b><input type="text" name="discountparcentinPatient" id="discountparcentinPatient" value="0"  /></b></td>
                    </tr>
                    <tr>

                        <td colspan="7" align="right"><b>Discount Amount&nbsp;&nbsp;</b></td>
                        <td align="center"><b><input type="text" name="discountamountinPatient" id="discountamountinPatient" value="0"  /></b></td>
                    </tr>
                    <tr>

                        <td colspan="7" align="right"><b>Total Value&nbsp;&nbsp;</b></td>
                        <td align="center"><b><input type="text" name="totalvalueinPatient" id="totalvalueinPatient" value="0" readonly /></b></td>
                    </tr>  --%>

                    <tr>
                        <td colspan="10" width="66%" height="26" style="border:hidden">&nbsp;</td>
                        <td width="21%" align="right"><b>Medicine Total&nbsp;&nbsp;</b></td>
                        <td align="center" style="width: 15%"><input type="text" name="medicineTotalAmountinPatient" id="medicineTotalAmountinPatient" value="0" readonly /></td>
                    </tr>
                    <tr>
                        <td colspan="10" height="24" style="border:hidden">&nbsp;</td>
                        <td height="24" align="right"><b>Bill Value&nbsp;&nbsp;</b></td>
                        <td height="24" align="center" style="width: 15%"><b><input type="text" name="grandTotalAmountinPatient" id="grandTotalAmountinPatient" value="0" readonly /></b></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="22" align="center" style="width: 15%"><b><input type="text" name="discountparcentinPatient" id="discountparcentinPatient" value="0" /></b></td>
                    </tr>
                    <tr>
                        <td colspan="10" height="27" style="border:hidden">&nbsp;</td>
                        <td height="27" align="right"><b>Discount Amount(-)&nbsp;</b></td>
                        <td height="27" align="center" style="width: 15%"><b><input type="text" name="discountamountinPatient" id="discountamountinPatient" value="0"  /></b></td>
                    </tr>
                    <tr>
                        <td colspan="10" height="27" style="border:hidden">&nbsp;</td>
                        <td height="27" align="right"><b>Total Payable&nbsp;&nbsp;</b></td>
                        <td height="27" align="center" style="width: 15%"><b><input type="text" name="totalvalueinPatient" id="totalvalueinPatient" value="0" readonly /></b></td>
                    </tr>
                </tfoot>
            </TABLE>
            ...
            <table id="dataTable" width="100%" border="0">
                <tr>
                    <td >
                        <button id="removeDossageinPatient">Remove</button>
                    </td>
                    <td align="right">
