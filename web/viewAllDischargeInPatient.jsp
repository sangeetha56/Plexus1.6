        ...
        <script type="text/javascript">
            function deleteRecords(){
                var form1=document.getElementById("form1");
                 ...
                 var con=false
                con=confirm('Do You Want To Dedelet Selected Patient Record');
                if(!con)
                {
                    form1.action="viewAllInPatientManage.jsp";
                }
                else
                    {
                        form1.action="Controller?process=InPatientProcess&action=deleteMultiple";
                        form1.submit();
        ...
        <form name="form1" id="form1" action="" method="post">
            <div class="wrapper"><!--wrapper started-->
                <div class="header_new">
                    <center><strong >In-Patient Discharge List </strong></center>
                </div>
                    ...
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        <thead >
                            <tr  >
                                ...
                                <th title="click to sort" class="headerText">Discharge Date</th>
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${inpatientDischargeList}" var="patient">
                                ...
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    ...
                                    <td  class="dataTextInActive"><a  class="dataTextInActive"  href="Controller?process=InPatientProcess&action=viewDetails&id=<c:out  value='${patient.id}'/>"><c:out value="${patient.cardno}"/></a></td>
                                    ...
                                    <td class="dataText"   ><c:out value="${patient.dischargedate}"/></td>
            ...
            <script type="text/javascript">
                ...
                function CallFunction()
                {
                    ...
                    form1.action="Controller?process=InPatientProcess&action=viewAllDischargeInPatient&alphabit=null";
