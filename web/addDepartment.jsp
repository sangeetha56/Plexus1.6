<%-- 
    ...
    Created on : Feb 12, 2016, 5:31:51 PM
    Author     : INTEL
--%>
...
background-image: url();background-repeat: no-repeat;background-position: center;
        ...
        <script>
            ...
            function exist(exis)
            {
               for (var i=0; i<document.getElementById('departmentnameid').options.length; i++)
                {

                    if (document.getElementById('departmentnameid').options[i].text == exis)
                    {
    ...
    <body >
        <div  id="bord" >
        <form id="form1"  action="Controller?process=DepartmentProcess&action=add" method="POST" >
            <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Add Department Information</span></div></td>
                </tr>
            </table>
            <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                <tr>
                    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
                            ...
                            <select style="width: 200px; display: none" name="departmentnameid" id="departmentnameid"  class="style7">
                            ...
                            <tr>
                                <td height="44"><div align="right"><span class="style1">Department Name</span></div></td>
                                <td>&nbsp;</td>
                                <td>:</td>
                                <td><div align="left">
                                        <input type="text" onkeyup="exist(this.value);" name="DepartmentName" id="DepartmentName" style="width:200px" class="style7" />
                                    </div></td>
                                <td colspan="3">&nbsp;</td>
                            </tr>
          ...
          var country=document.getElementById("DepartmentName");
                ...
                var form1=document.getElementById("form1");
                 //alert(form1.DepartmentName.value)
                form1.action="Controller?process=DepartmentProcess&action=add";
              form1.submit();
