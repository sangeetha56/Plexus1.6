<%--
    Document   : therapybillDetail
    Created on : Aug 6, 2014, 3:23:54 PM
    Author     : sultan
--%>
            ...
            <table width="100%">
               <thead>
                   <tr style="display: none" >
                        ...
                        <td  class="headerText">Consultancy Bill Charges Details</td>
                     ...
                     %>
                       ...
                       <c:forEach items="${therapybill.detailstherapybills}" var="therapyk">
                        <tr>
                            ...
                            <td class="dataText" align="center"><c:out value="${therapyk.detailstherapybillcharge}" /></td>
                            <td class="dataText" align="center"><c:out value="${therapyk.detailstherapybillcharge}" /></td>
