...
window.back();
    ...
    <table  width="100%">
                ...
                <tbody>
                    ...
                    <tr><td style="width: 45%" align="left">Invoice No: <c:out value="${advance.investigationbillid}"/></td></tr>
                    ...
                    <tr>
                        ...
                        <td class="dataText">Visit Date: <fmt:formatDate pattern="dd MMMM yyyy " value="${advance.investigationbilldate}" /> </td>
