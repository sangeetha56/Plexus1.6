<%-- 
    Document   : viewExpiringStock_Jquery
    Created on : Jan 8, 2016, 3:47:25 PM
    Author     : INTEL
--%>
    ...
    <body>
        <form name="form1" id="form1" action="" method="post">
            <div class="wrapper"><!--wrapper started-->
                ...
                <div class="">
                    <table width="100%" style="border-color:#4b6a84;overflow: hidden;"   id="myTable">
                         <thead >
                        <tr>
                    ...
                    <tbody  >
                        <c:forEach varStatus="count"  items="${expiringStocks}" var="stock"  >
