<%-- 
    Document   : managebeddetail
    Created on : Jul 18, 2016, 4:17:58 PM
    Author     : kamal
--%>
        ...
        <script type="text/javascript">
            function deleteRecords(){
                var form1=document.getElementById("form1");
                 ...
                 var con=false
                con=confirm('Do You Want To Delete Selected  Record');
                if(!con)
                {
                    form1.action="managebeddetail.jsp";
                }
                else
                    {
                        form1.action="Controller?process=BedManagement&action=deleteMultiple";
                        form1.submit();
        ...
        <div id="bord">
            <form name="form1" id="form1" action="" method="post">
                <div style="overflow: hidden">
                    <table width="100%">
                        <tr>
                            <td  class="headerTD">Manage Bed Type </td>
                        </tr>
                        ...
                        <tbody>
                            <c:forEach items="${bedSetUpList}" var="bed">
                                ...
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    ...
                                    <td class="dataText"><input type="checkbox" id = "<c:out value="${bed.beddetailsid}"/>" class = "chcktbl"  name="patientIDs"  value="<c:out value="${bed.beddetailsid}"/>"/></td>
                                      <td  class="dataTextInActive"><a  class="dataTextInActive"  href="Controller?process=BedManagement&action=viewDetails&id=<c:out  value='${bed.beddetailsid}'/>"><c:out value="${bed.roomndbedsetup.roomsetup.buildingtypesetup.buildingblock}"/></a></td>

                                    <td  class="dataText"><c:out value="${bed.roomndbedsetup.roomsetup.floorno}"/></td>
                                    <td  class="dataText"><c:out value="${bed.roomndbedsetup.roomno}"/></td>
                                    <td  class="dataText"><c:out value="${bed.roomndbedsetup.roomcode}"/></td>
                                    <td  class="dataText"><c:out value="${bed.bedno}"/></td>
