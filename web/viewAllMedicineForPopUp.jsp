<%-- 
    Document   : viewAllMedicineForPopUp
    Created on : Apr 4, 2016, 3:05:41 PM
    Author     : kamal
--%>
...
<html >
    <head >
        ...
        <script type="text/javascript">
            ...
            function writeName(id,name,strength,nature,availableTotalStock,expirydate,price,batchno,cgst,sgst,igst,vat,usable) {
               // alert("for inserting value:"+id+"name is:-"+name);
               // alert("opener values are:-"+opener.fName);
                var condition=opener.fName;
              // alert("condition value is:-"+condition);
               if(condition==1)
                   {
                       alert("for 1");
                       opener.form1.medid.value = id;
                opener.form1.medname.value = name;
                opener.form1.medstrength.value = strength;
                opener.form1.mednature.value = nature;
                opener.form1.medavailableTotalStock.value = availableTotalStock;
                opener.form1.medexpirydate.value = expirydate;
                opener.form1.medprice.value = price;
                opener.form1.medbatchno.value = batchno;
                opener.form1.medcgst.value = cgst;
                opener.form1.medsgst.value = sgst;
                opener.form1.medigst.value = igst;
                opener.form1.medvat.value = vat;
                opener.form1.medusable.value = usable;
                   }
                   else if(condition==2)
                   {
                       alert("for 2");
                   opener.form1.medid2.value = id;
                opener.form1.medname2.value = name;
                opener.form1.medstrength2.value = strength;
                opener.form1.mednature2.value = nature;
                opener.form1.medavailableTotalStock2.value = availableTotalStock;
                opener.form1.medexpirydate2.value = expirydate;
                opener.form1.medprice2.value = price;
                opener.form1.medbatchno2.value = batchno;
                opener.form1.medcgst2.value = cgst;
                opener.form1.medsgst2.value = sgst;
                opener.form1.medigst2.value = igst;
                opener.form1.medvat2.value = vat;
                opener.form1.medusable2.value = usable;
                   }
        ...
        <form name="form1" id="form1" action="" method="post">
            <div class="wrapper"><!--wrapper started-->
                <div class="header_new">
                    <center><strong >Medicine Availablity For Dispense </strong></center>
                </div>
                    ...
                    <table width="100%" style="border-color:#4b6a84;"   id="myTable">
                        <thead >
                            <tr  >
                                ...
                                <th title="click to sort" class="headerText" >Medicine ID</th>
                                ...
                                <th title="click to sort" class="headerText">Avialable Stock</th>
                                <th title="click to sort" class="headerText">Expiry Date</th>
                                <th title="click to sort" class="headerText">Price</th>
                                <th title="click to sort" class="headerText">Batchno</th>
                                <th title="click to sort" class="headerText">CGST</th>
                                <th title="click to sort" class="headerText">SGST</th>
                                <th title="click to sort" class="headerText">IGST</th>
                                <th title="click to sort" class="headerText">GST</th>
                                <th title="click to sort" class="headerText">Usable</th>
                        ...
                        <tbody  >
                            ...
                            <c:forEach items="${medicines}" var="crrentstock">
                                <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                    <td class="dataText"><%=i%></td>
                                    <td  class="dataText"><c:out value="${crrentstock.id}"/></td>
                                    <td  class="dataText" onclick="writeName('<c:out value="${crrentstock.id}"/>','<c:out value="${crrentstock.name}"/>','<c:out value="${crrentstock.strength}"/>','<c:out value="${crrentstock.nature}"/>','<c:out value="${crrentstock.availableTotalStock}"/>','<c:out value="${crrentstock.expirydate}"/>','<c:out value="${crrentstock.price}"/>','<c:out value="${crrentstock.batchno}"/>','<c:out value="${crrentstock.vat}"/>','<c:out value="${crrentstock.usable}"/>')" style="cursor: pointer;" title="Click to attach this medicine"><c:out value="${crrentstock.name}"/></td>
                                    <td  class="dataText"><c:out value="${crrentstock.strength}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.nature}"/></td>

                                    <td  class="dataText"><c:out value="${crrentstock.availableTotalStock}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.expirydate}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.price}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.batchno}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.cgst}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.sgst}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.igst}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.vat}"/></td>
                                    <td class="dataText"><c:out value="${crrentstock.usable}"/></td>
            ...
            <script type="text/javascript">
                ...
                function CallFunction()
                {
                    ...
                    form1.action="Controller?process=StockProcess&action=viewAllCurrentStockNoLimit&alphabit=null";
