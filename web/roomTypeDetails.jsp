<%-- 
    Document   : roomTypeDetails
    Created on : Jul 5, 2016, 4:36:26 PM
    Author     : INTEL
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                .button()
                .click(function() {
                    window.location='roomTypeDetails.jsp'
                });
                ...
                .click(function() {
                    // backButttonn();
                    window.location='roomTypeTab.jsp';
        ...
        <script>
            function editable()
            {
                ...
                document.getElementById("RoomCharges").disabled=false;
            ...
            <form id="form1"  action="" method="POST" >
                <table width="100%" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td height="29" valign="top" background="images/header-bg.png" style="background-repeat:repeat-x"><div align="center"><span class="style3">Room Type Information</span></div></td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                            <input disabled="true" type="text"  name="RoomCode" id="RoomCode" value="<c:out value="${detailsOfRoom.roomcode}"/>"  style="width:180px" class="style7" />
                                        </div></td>
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                            <input disabled="true" type="text" name="RoomType" id="RoomType" value="<c:out value="${detailsOfRoom.roomtype}"/>" style="width:180px" class="style7" />
                                        </div></td>
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                            <input disabled="true" type="text" name="RoomCharges" id="RoomCharges" value="<c:out value="${detailsOfRoom.roomcharges}"/>" style="width:180px" class="style7" />
                                        </div></td>
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                            ...
                            <script type="text/javascript">
                                ...
                                function deleteRoomType(){
                                    ...
                                    if(!con)
                                    {
                                        form1.action="roomTypeDetails.jsp";
                                    }
                                    else
                                    {
                                        var form1=document.getElementById("form1");
                                        form1.action="Controller?process=RoomProcess&action=delete&id=<c:out value="${detailsOfRoom.roomtypeid}"/>";
                                        form1.submit();
                                ...
                                function editRoomType(){
                                    ...
                                    {
                                        var form1=document.getElementById("form1");
                                        form1.action="Controller?process=RoomProcess&action=updateRoom&id=<c:out value="${detailsOfRoom.roomtypeid}"/>";
                                        form1.submit();
